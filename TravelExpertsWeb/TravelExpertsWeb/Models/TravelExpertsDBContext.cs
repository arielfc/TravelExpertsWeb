...
namespace TravelExpertsWeb.Models
{
    public partial class TravelExpertsDBContext : DbContext
    {
        ...
        public TravelExpertsDBContext(DbContextOptions<TravelExpertsDBContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=tcp:ariel.database.windows.net,1433;Initial Catalog=TravelExpertsDB;Persist Security Info=False;User ID=arieldb;Password=cr3DE_nt14Ls;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customers>(entity =>
            {
                ...
                entity.Property(e => e.CustUserName).HasMaxLength(25);
