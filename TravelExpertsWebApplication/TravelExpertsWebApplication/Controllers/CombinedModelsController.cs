...
{
    public class CombinedModelsController : Controller
    {
        private readonly TravelExpertsContext _context;//TravelExpertsContext

        public CombinedModelsController(TravelExpertsContext context)//TravelExpertsContext
        {
            _context = context;
        }
        ...
        public ActionResult Index(int? id)
        {
            ...
            CombinedModels results = new CombinedModels();
